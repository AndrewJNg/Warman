...
void OLED_display_stats() {
  ...
  if (currentMillis - prevMillis >= 100) {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // target speeds
    OLED.print("squashSpeed: \t");
    OLED.println(squashSpeed);
    
    OLED.print("squashDiff:  \t");
    OLED.println(squashDiff);
    
    OLED.print("tennisSpeed: \t");
    OLED.println(tennisSpeed);
    
    OLED.print("tennisDiff:  \t");
    OLED.println(tennisDiff);

    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // current sense data

    OLED.print("tof: \t");
    OLED.println(tof_distance);
    ...
    /*
    OLED.print("P: \t");
    OLED.println(KpLeft,4);
    OLED.print("I: \t");
    OLED.println( KiLeft,4);
    
    OLED.print("D: \t");
    OLED.println(KdLeft,4);
    */
